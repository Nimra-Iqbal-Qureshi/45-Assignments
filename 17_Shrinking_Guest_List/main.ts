let guestList:string[]=["Asad","Shahid","Zahid","Salar"];
...
console.log(`Sorry Mr:${guestList[2]},you are not invited for dinner.`); 
console.log(`Sorry Mr:${guestList[3]},you are not invited for dinner.`); 
